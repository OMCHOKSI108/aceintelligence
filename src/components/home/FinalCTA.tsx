    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
      <div className="rounded-2xl bg-slate-900 text-white p-8 sm:p-12 text-center">
        <h2 className="headline-primary text-3xl sm:text-4xl mb-4">
          Ready to automate your most important workflows?
        </h2>
        <p className="text-slate-300 text-lg mb-8 max-w-2xl mx-auto">
          Join our beta. Book a demo. See how Ace Intelligence builds approvals, guardrails,
          and visibility into every workflow.
        </p>
